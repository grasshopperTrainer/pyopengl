...
try:
    ...
    try:
        ...
        _log.error( """Unable to import Tkinter, likely need to install a separate package (python-tk) to have Tkinter support.  You likely also want to run the my_src/togl.py script in the PyOpenGL source distribution to install the Togl widget""" )
        raise
import math
...
# This code is intended to work with the my_src/togl.py script 
