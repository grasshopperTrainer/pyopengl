...
OpenGL.raw.GLX.SGIS.multisample to provide a more
Python-friendly API
...
from OpenGL.raw.GLX.SGIS.multisample import *
from OpenGL.raw.GLX.SGIS.multisample import _EXTENSION_NAME
