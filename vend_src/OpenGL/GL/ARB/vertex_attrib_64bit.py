...
Overview (from the spec)
	...
	inputs with 64-bit floating-point parts and OpenGL API support for
	...
	specify attributes with 64-bit floating-point parts.  This extension
	...
	Additionally, some vertex shader inputs using the wider 64-bit parts
	...
	specify bindless vertex attribute arrays with 64-bit parts, integer
	or floating-point.
