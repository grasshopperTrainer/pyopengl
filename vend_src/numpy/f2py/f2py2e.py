...
def run_main(comline_list):
    ...
    fobjhsrc = os.path.join(f2pydir, 'my_src', 'fortranobject.h')
    fobjcsrc = os.path.join(f2pydir, 'my_src', 'fortranobject.c')
...
def run_compile():
    ...
    if '-m' in sys.argv:
        ...
        pyf_files, sources = filter_files('', '[.]pyf([.]my_src|)', sources)
