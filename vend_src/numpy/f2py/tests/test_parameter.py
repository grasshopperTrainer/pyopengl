...
class TestParameters(util.F2PyTest):
    ...
    sources = [_path('my_src', 'parameter', 'constant_real.f90'),
               _path('my_src', 'parameter', 'constant_integer.f90'),
               _path('my_src', 'parameter', 'constant_both.f90'),
               _path('my_src', 'parameter', 'constant_compound.f90'),
               _path('my_src', 'parameter', 'constant_non_compound.f90'),
    ]
