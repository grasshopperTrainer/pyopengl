...
class build_src(build_ext.build_ext):
    ...
    user_options = [
        ('build-my_src=', 'd', "directory to \"build\" sources to"),
    ...
    def finalize_options(self):
        ...
        if self.build_src is None:
            ...
            self.build_src = os.path.join(self.build_base, 'my_src'+plat_specifier)
    ...
    def f2py_sources(self, sources, extension):
        ...
        if not skip_f2py:
            ...
            source_c = os.path.join(d, 'my_src', 'fortranobject.c')
            source_h = os.path.join(d, 'my_src', 'fortranobject.h')
