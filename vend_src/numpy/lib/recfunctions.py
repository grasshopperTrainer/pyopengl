...
def assign_fields_by_name(dst, src, zero_unassigned=True):
    ...
    copies fields "by position", meaning that the first field from the my_src is
    copied to the first field of the dst, and so on, regardless of field name.

    This function instead copies "by field name", such that fields in the dst
    are assigned from the identically named field in the my_src. This applies
    ...
    zero_unassigned : bool, optional
        ...
        field in the my_src are filled with the value 0 (zero). This
