...
# Note: Both scalartypes.c.my_src and arrayprint.py implement strs for numpy
# scalars but for different purposes. scalartypes.c.my_src has str/reprs for when
...
def _void_scalar_repr(x):
    ...
    scalartypes.c.my_src code, and is placed here because it uses the elementwise
